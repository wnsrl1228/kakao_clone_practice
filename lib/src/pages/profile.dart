...
import 'package:kakao_clone_practice/src/components/text_editor_widget.dart';
...
class Profile extends GetView<ProfileController> {
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  _oneButton(Icons.edit, "프로필편집", controller.toggleEditProfile),
  ...
  Widget _profileImageWidget() {
    return controller.myProfile.value.avatarUrl == null
        ...
        : Image.network(controller.myProfile.value.avatarUrl,
            fit: BoxFit.cover);
  }
