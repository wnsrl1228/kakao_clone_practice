...
import 'package:kakao_clone_practice/src/repository/firebase_user_repository.dart';
import 'package:kakao_clone_practice/src/repository/firestorage_repository.dart';
...
class ProfileController extends GetxController {
  ...
  void _updateBackgroundUrl(String downloadUrl) {
  ...
  void save() {
    ...
    if (originMyProfile.backgroundFile != null) {
      ...
      task.snapshotEvents.listen((event) async {
        if (event.bytesTransferred == event.totalBytes) {
          String downloadUrl = await event.ref.getDownloadURL();
          _updateBackgroundUrl(downloadUrl);
          FirebaseUserRepository.updateImageUrl(
